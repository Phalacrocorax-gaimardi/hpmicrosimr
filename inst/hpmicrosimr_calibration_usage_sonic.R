...
sD <- readxl::read_xlsx("/home/people/jwheatley/hpretrofit/calibration/scenario_parameters.xlsx",sheet="WEM")
...
min_fun2 <- function(x){
  ...
  df <- calABM(sD,Nrun=32,2,TRUE,nu=x[1],p=x[2],beta = x[3],r = x[4],eta = x[5],tau = x[6],rho=0.3)
...
write_csv(macro_calibration,paste("/home/people/jwheatley/hpretrofit/calibration/macro_calibration_1.csv",sep=""))
